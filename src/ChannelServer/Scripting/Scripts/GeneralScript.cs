...
namespace Aura.Channel.Scripting.Scripts
{
	...
	public abstract class GeneralScript : IDisposable, IScript, IAutoLoader
	{
		...
		protected void AddConsoleCommand(string name, string description, ConsoleCommandFunc handler)
		{
			ChannelServer.Instance.ConsoleCommands.Add(name, "", description, handler);
		}
